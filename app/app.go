...
var (
	_ runtime.AppI                = (*AESCApp)(nil)
	_ cosmosevmserver.Application = (*AESCApp)(nil)
	_ ibctesting.TestingApp       = (*AESCApp)(nil)
)

// AESCApp extends an ABCI application, but with most of its parameters exported.
type AESCApp struct {
	*baseapp.BaseApp
...
// NewAescApp returns a reference to an initialized AESCApp.
func NewAescApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *AESCApp) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *AESCApp) onPendingTx(hash common.Hash) {
...
func (app *AESCApp) RegisterPendingTxListener(listener func(common.Hash)) {
	app.pendingTxListeners = append(app.pendingTxListeners, listener)
}

func (app *AESCApp) setPostHandler() {
...
func (app *AESCApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *AESCApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *AESCApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *AESCApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *AESCApp) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *AESCApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *AESCApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *AESCApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns AESCApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *AESCApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns AESCApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *AESCApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns AESCApp's InterfaceRegistry
func (app *AESCApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns AESCApp's TxConfig
func (app *AESCApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *AESCApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *AESCApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *AESCApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *AESCApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// SimulationManager implements the SimulationApp interface
func (app *AESCApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *AESCApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *AESCApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *AESCApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *AESCApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *AESCApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *AESCApp) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *AESCApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *AESCApp) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *AESCApp) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *AESCApp) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *AESCApp) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *AESCApp) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *AESCApp) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *AESCApp) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *AESCApp) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *AESCApp) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *AESCApp) GetConsensusParamsKeeper() consensusparamkeeper.Keeper {
	return app.ConsensusParamsKeeper
}

func (app *AESCApp) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *AESCApp) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *AESCApp) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *AESCApp) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}

func (app *AESCApp) GetMintKeeper() mintkeeper.Keeper {
	return app.MintKeeper
}

func (app *AESCApp) GetPreciseBankKeeper() *precisebankkeeper.Keeper {
	return &app.PreciseBankKeeper
}

func (app *AESCApp) GetCallbackKeeper() ibccallbackskeeper.ContractKeeper {
	return app.CallbackKeeper
}

func (app *AESCApp) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *AESCApp) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *AESCApp) GetMempool() sdkmempool.ExtMempool {
	return app.EVMMempool
}

func (app *AESCApp) GetAnteHandler() sdk.AnteHandler {
	return app.BaseApp.AnteHandler()
}

// GetTxConfig implements the TestingApp interface.
func (app *AESCApp) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *AESCApp) SetClientCtx(clientCtx client.Context) { // TODO:VLAD - Remove this if possible
	app.clientCtx = clientCtx
}

// Close unsubscribes from the CometBFT event bus (if set) and closes the mempool and underlying BaseApp.
func (app *AESCApp) Close() error {
	var err error
...
func (app *AESCApp) AutoCliOpts() autocli.AppOptions {
