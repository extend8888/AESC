...
// file.
func (app *AESCApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *AESCApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
