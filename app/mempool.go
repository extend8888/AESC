...
func (app *AESCApp) configureEVMMempool(appOpts servertypes.AppOptions, logger log.Logger) error {
...
func (app *AESCApp) createMempoolConfig(appOpts servertypes.AppOptions, logger log.Logger) (*evmmempool.EVMMempoolConfig, error) {
