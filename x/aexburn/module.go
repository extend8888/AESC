...
import (
	...
	"github.com/sei-protocol/sei-chain/x/aexburn/client/cli"
...
// Note: Gas accumulation has been moved to App-level EndBlocker to ensure
// BurnFees (through distr hook) has access to the latest gas data
