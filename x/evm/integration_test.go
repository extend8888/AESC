...
func TestERC721RoyaltiesPointerToCW721Royalties(t *testing.T) {
	...
	require.Nil(t, k.BankKeeper().AddCoins(ctx, seiAddr, sdk.NewCoins(sdk.NewCoin("uaex", sdk.NewInt(10000000))), true))
...
func TestInvalidAssociateMsg(t *testing.T) {
	...
	amt := sdk.NewCoins(sdk.NewCoin("uaex", sdk.NewInt(1000000)))
