...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorOutstandingRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"rewards":[{"denom":"uaex","amount":"1164.240000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorCommission() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"commission":[{"denom":"uaex","amount":"464.520000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryDelegatorRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			fmt.Sprintf(`{"rewards":[{"validator_address":"%s","reward":[{"denom":"uaex","amount":"387.100000000000000000"}]}],"total":[{"denom":"uaex","amount":"387.100000000000000000"}]}`, valAddr.String()),
		},
		{
			...
			false,
			`{"rewards":[{"denom":"uaex","amount":"387.100000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryCommunityPool() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"pool":[{"denom":"uaex","amount":"4.740000000000000000"}]}`,
		},
		{
			"text output",
