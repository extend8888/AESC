...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("uaex", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	coins := sdk.NewCoins(sdk.NewCoin("mytoken", sdk.NewInt(2)), sdk.NewCoin("uaex", sdk.NewInt(2)))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin("uaex", expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin("uaex", expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("uaex", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
