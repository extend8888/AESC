...
contract MockBank {
    ...
    function balance(address account, string memory denom) public view returns (uint256) {
        require(keccak256(abi.encodePacked(denom)) == keccak256(abi.encodePacked("uaex")), "MockBank: denom not supported");
...
contract NativeSeiTokensERC20Test is Test {
    ...
    function setUp() public {
        ...
        bob = makeAddr("bob");
        seiERC20 = new NativeSeiTokensERC20("uaex", "SEI", "SEISYMBOL", 6);
    ...
    function testBalanceOf() public {
        vm.mockCall(BANK_PRECOMPILE_ADDRESS, abi.encodeWithSelector(IBank.balance.selector, address(this), "uaex"), abi.encode(123));
    ...
    function testTotalSupply() public {
        vm.mockCall(BANK_PRECOMPILE_ADDRESS, abi.encodeWithSelector(IBank.supply.selector, "uaex"), abi.encode(123));
