...
seid add-genesis-account "$VALIDATOR_ADDRESS" 1000000000000000000000uaex,1000000000000000000000ustaex,1000000000000000000000uusdc,1000000000000000000000uatom

# Add admin account
printf "12345678\n" | seid add-genesis-account admin 1000000000000000000000uaex,1000000000000000000000ustaex,1000000000000000000000uusdc,1000000000000000000000uatom
...
for i in {1..10}; do
    ...
    if [ -n "$ADMIN_ADDRESS" ]; then
        ...
        seid add-genesis-account "$ADMIN_ADDRESS" 1000000000000000000000uaex,1000000000000000000000ustaex,1000000000000000000000uusdc,1000000000000000000000uatom
    else
...
if [ -f build/generated/genesis_accounts.txt ]; then
    while read account; do
      echo "Adding: $account"
      seid add-genesis-account "$account" 1000000000000000000000uaex,1000000000000000000000ustaex,1000000000000000000000uusdc,1000000000000000000000uatom
